...
(function (window, jQuery) {
    jQuery(document).ready(function ($) {
        ...
        var p1 = new Image();
        p1.src = "//dn-shuiqian-cc.qbox.me/public/index/img/phone1.png?1";
        var p2 = new Image();
        p2.src = "//dn-shuiqian-cc.qbox.me/public/index/img/phone2.png?1";

        function w1800(){
            if ($("html").width() > 1800) {
                $(".container").addClass("w1800");
                $(".fifth .aboveblock .center").addClass("w1800");
            }else{
                $(".container").removeClass("w1800");
                $(".fifth .aboveblock .center").removeClass("w1800");
            }
        };
        ...
        $('#fullpage').fullpage({
            ...
            afterLoad: function (anchorLink, index) {
                ...
                if(index == 5){
                    $(".fifth .star img").click(function(){$.fn.fullpage.moveTo(1);});
                    $(".fifth .ball img").click(function(){$.fn.fullpage.moveTo(2);});
                    $(".fifth .smile img").click(function(){$.fn.fullpage.moveTo(3);});
                    $(".fifth .loc img").click(function(){$.fn.fullpage.moveTo(4);});
                }
            },
        ...
        (function androiddown() {
            $(".androiddown").click(function () {
                var url = "http://"+bed.serverURL+"/Download/";
        ...
        function initMobiles() {
            ...
            $(".phone1").animate({
                ...
                $(".star").animate({
                    opacity: 1
                }, 1000, function () {//显示下载链接 二维码

                    imageFitDiv($(".downwrap"), "img.down", 775.0, 642.0);
                    $(".first .down").fadeIn(800, function () {
            ...
            //星星定位
            $(".first .star img").css("bottom", $(".star").height() * 0.2 + "px");

            //$(".fifth .star img").css("bottom", $(".star").height() * 0.2 + "px");
        }
        ...
        function initPops(initImg) {
            ...
            if(initImg){
                $(".pop4 img").fadeIn(800,function(){
                    $(".pop1 img").fadeIn(800,function(){
                        $(".pop2 img").fadeIn(800,function(){
                           $(".pop3 img").fadeIn(800);
                        });
                    });
                });
        ...
        function initHearts(initImg) {
            ...
            if(initImg){
                $(".voices").fadeIn(1800,function(){
                    $(".gn").fadeIn(1200,function(){
                        $(".gn").addClass("zoomOutUp animated");
                    });
                });
            }
        }
        ...
        function initConn() {
            ...
            //定位connpop
            $(".connpop").css({
                left:(-250.0)/869*$("img.f1").width()+"px",
                top:164.0/763*$("img.f1").height()+"px",
                width:$("img.f1").width()/691*1100.0+"px"
            });
        ...
        var smileChange = {
            start: function () {
                ...
                this.intervalId = setInterval(function () {
                    ...
                    $(".third .smile img").attr("src", "./public/index/img/smile-on-2.png");
                    that.timeoutId = setTimeout(function () {
                        $(".third .smile img").attr("src", "./public/index/img/smile-off-2.png");
                    }, 500);
